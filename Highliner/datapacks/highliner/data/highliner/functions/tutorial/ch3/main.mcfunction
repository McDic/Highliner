execute if score !tutorial_timer constants matches 0 run function highliner:tutorial/ch3/p0
execute if score !tutorial_timer constants matches 60 run function highliner:tutorial/ch3/p1
execute if score !tutorial_timer constants matches 140 run function highliner:tutorial/ch3/p2
