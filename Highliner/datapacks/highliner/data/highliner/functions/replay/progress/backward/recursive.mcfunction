...
function highliner:replay/progress/backward/unit_tile with storage highliner:temp_storage temp_prev_state
...
function highliner:replay/progress/backward/recursive with storage highliner:temp_storage temp_args
