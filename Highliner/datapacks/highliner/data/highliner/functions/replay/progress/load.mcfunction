...
execute store result score !replay_is_red_placed constants run data get storage highliner:temp_storage temp_diff.is_red_placed 1
function highliner:game/get_turn
execute store result score !timer_red constants run data get storage highliner:temp_storage temp_diff.timer_red 1
execute store result score !timer_blue constants run data get storage highliner:temp_storage temp_diff.timer_blue 1
execute store result score !placing_direction constants run data get storage highliner:temp_storage temp_diff.placing_direction 1
