...
execute if score !tile_theme constants matches 0 run tellraw @a {"translate":"highliner.gamestatus.settings.theme","color":"yellow","italic":true,"with":[{"translate":"highliner.lobby.sign.theme.wool"}]}
execute if score !tile_theme constants matches 1 run tellraw @a {"translate":"highliner.gamestatus.settings.theme","color":"yellow","italic":true,"with":[{"translate":"highliner.lobby.sign.theme.concrete"}]}
execute if score !tile_theme constants matches 2 run tellraw @a {"translate":"highliner.gamestatus.settings.theme","color":"yellow","italic":true,"with":[{"translate":"highliner.lobby.sign.theme.concrete_powder"}]}
execute if score !tile_theme constants matches 3 run tellraw @a {"translate":"highliner.gamestatus.settings.theme","color":"yellow","italic":true,"with":[{"translate":"highliner.lobby.sign.theme.terracotta"}]}
execute if score !tile_theme constants matches 4 run tellraw @a {"translate":"highliner.gamestatus.settings.theme","color":"yellow","italic":true,"with":[{"translate":"highliner.lobby.sign.theme.ore"}]}
execute if score !tile_theme constants matches 5 run tellraw @a {"translate":"highliner.gamestatus.settings.theme","color":"yellow","italic":true,"with":[{"translate":"highliner.lobby.sign.theme.hyphae"}]}
