...
item replace entity @s[advancements={highliner:game_master=true},team=spectators] armor.head with minecraft:gray_banner{display:{Name:'{"translate":"highliner.advancements.title.game_master","color":"yellow"}'},Enchantments:[{id:"binding_curse",lvl:1}],BlockEntityTag:{Base:7,Patterns:[{Pattern:bri,Color:4},{Pattern:bo,Color:15}]}}
item replace entity @s[advancements={highliner:game_master=true},team=redteam] armor.head with minecraft:gray_banner{display:{Name:'{"translate":"highliner.advancements.title.game_master","color":"dark_red"}'},Enchantments:[{id:"binding_curse",lvl:1}],BlockEntityTag:{Base:7,Patterns:[{Pattern:bri,Color:14},{Pattern:bo,Color:15}]}}
item replace entity @s[advancements={highliner:game_master=true},team=blueteam] armor.head with minecraft:gray_banner{display:{Name:'{"translate":"highliner.advancements.title.game_master","color":"aqua"}'},Enchantments:[{id:"binding_curse",lvl:1}],BlockEntityTag:{Base:7,Patterns:[{Pattern:bri,Color:3},{Pattern:bo,Color:15}]}}
