...
execute if score !is_red_turn constants matches 1 if score !tile_theme constants matches 6 run fill ~ 73 ~ ~3 73 ~3 minecraft:redstone_block replace minecraft:lime_wool
