...
execute if score !is_red_turn constants matches 1 if score !tile_theme constants matches 6 run summon minecraft:falling_block ~ 80 ~ {BlockState: {Name: "minecraft:redstone_block"}, Time: 0, DropItem: false}
