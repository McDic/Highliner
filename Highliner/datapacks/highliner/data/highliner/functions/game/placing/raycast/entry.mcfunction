...
tp @e[type=minecraft:marker,name="placing_raycast"] @s
scoreboard players set @e[type=minecraft:marker,name="placing_raycast"] gps_y 999
execute as @e[type=minecraft:marker,name="placing_raycast",x_rotation=15..90] run execute at @s run function highliner:game/placing/raycast/recursive_move
