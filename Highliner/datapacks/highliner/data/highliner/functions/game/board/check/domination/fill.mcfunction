...
execute if score !is_red_turn constants matches 1 if score !tile_theme constants matches 6 run fill ~ 73 ~ ~3 73 ~3 minecraft:amethyst_block
...
execute if score !is_red_turn constants matches 0 if score !tile_theme constants matches 6 run fill ~ 73 ~ ~3 73 ~3 minecraft:lapis_block
