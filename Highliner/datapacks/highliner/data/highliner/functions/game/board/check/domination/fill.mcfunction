...
execute if score !is_red_turn constants matches 0 if score !tile_theme constants matches 0 run fill ~ 73 ~ ~3 73 ~3 minecraft:blue_concrete
execute if score !is_red_turn constants matches 0 if score !tile_theme constants matches 0 run fill ~ 73 ~ ~3 73 ~3 minecraft:blue_concrete_powder
execute if score !is_red_turn constants matches 0 if score !tile_theme constants matches 0 run fill ~ 73 ~ ~3 73 ~3 minecraft:blue_terracotta
execute if score !is_red_turn constants matches 0 if score !tile_theme constants matches 0 run fill ~ 73 ~ ~3 73 ~3 minecraft:deepslate_diamond_ore
execute if score !is_red_turn constants matches 0 if score !tile_theme constants matches 0 run fill ~ 73 ~ ~3 73 ~3 minecraft:warped_hyphae
