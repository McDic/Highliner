...
execute as @p[team=!spectators,scores={tried_placing=1..}] run function highliner:game/reset_items
...
execute as @p[team=!spectators,scores={rotated=1..}] run function highliner:game/reset_items
