...
execute if score !domination_diff_blue constants matches 1.. run advancement grant @a[team=blueteam] until highliner:ingame/domination/first
...
execute if score !domination_diff_blue constants matches 100.. run advancement grant @a[team=blueteam] until highliner:ingame/domination/huge_move
