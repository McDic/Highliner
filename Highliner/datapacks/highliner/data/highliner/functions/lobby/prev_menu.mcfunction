scoreboard players remove !current_lobby_menu constants 1
execute if score !current_lobby_menu constants matches -1.. as @s at @s run playsound minecraft:item.armor.equip_generic master @s ~ ~ ~
