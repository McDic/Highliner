...
execute unless score !credit_rotation_tester constants matches 0..14 run scoreboard players set !credit_rotation_tester constants 0
...
execute if score !credit_rotation_tester constants matches 14 as @e[type=minecraft:text_display,tag=lobby_display_text2] run function highliner:lobby/refresh_displays/credit/text {translation: "highliner.lobby.text.credit.tester", name: "anotherone_yt"}
execute if score !credit_rotation_tester constants matches 14 if score !current_lobby_selection constants matches 2 run function highliner:lobby/refresh_displays/credit/player_head {name: "anotherone_yt"}

scoreboard players add !credit_rotation_league_organizer constants 1
execute unless score !credit_rotation_league_organizer constants matches 0..6 run scoreboard players set !credit_rotation_league_organizer constants 0
...
execute if score !credit_rotation_league_organizer constants matches 2 as @e[type=minecraft:text_display,tag=lobby_display_text1] run function highliner:lobby/refresh_displays/credit/text {translation: "highliner.lobby.text.credit.league_organizer", name: "Deokia"}
execute if score !credit_rotation_league_organizer constants matches 2 if score !current_lobby_selection constants matches 1 run function highliner:lobby/refresh_displays/credit/player_head {name: "Deokia"}
execute if score !credit_rotation_league_organizer constants matches 3 as @e[type=minecraft:text_display,tag=lobby_display_text1] run function highliner:lobby/refresh_displays/credit/text {translation: "highliner.lobby.text.credit.league_organizer", name: "Hatming"}
execute if score !credit_rotation_league_organizer constants matches 3 if score !current_lobby_selection constants matches 1 run function highliner:lobby/refresh_displays/credit/player_head {name: "Hatming"}
execute if score !credit_rotation_league_organizer constants matches 4 as @e[type=minecraft:text_display,tag=lobby_display_text1] run function highliner:lobby/refresh_displays/credit/text {translation: "highliner.lobby.text.credit.league_organizer", name: "Uni0305"}
execute if score !credit_rotation_league_organizer constants matches 4 if score !current_lobby_selection constants matches 1 run function highliner:lobby/refresh_displays/credit/player_head {name: "Uni0305"}
execute if score !credit_rotation_league_organizer constants matches 5 as @e[type=minecraft:text_display,tag=lobby_display_text1] run function highliner:lobby/refresh_displays/credit/text {translation: "highliner.lobby.text.credit.league_organizer", name: "Risbean"}
execute if score !credit_rotation_league_organizer constants matches 5 if score !current_lobby_selection constants matches 1 run function highliner:lobby/refresh_displays/credit/player_head {name: "Risbean"}
execute if score !credit_rotation_league_organizer constants matches 6 as @e[type=minecraft:text_display,tag=lobby_display_text1] run function highliner:lobby/refresh_displays/credit/text {translation: "highliner.lobby.text.credit.league_organizer", name: "iMasterProX"}
execute if score !credit_rotation_league_organizer constants matches 6 if score !current_lobby_selection constants matches 1 run function highliner:lobby/refresh_displays/credit/player_head {name: "iMasterProX"}
