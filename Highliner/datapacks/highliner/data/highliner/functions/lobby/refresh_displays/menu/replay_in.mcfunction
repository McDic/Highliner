...
execute as @e[type=minecraft:text_display,tag=lobby_display_text2] run data modify entity @s[tag=!lobby_display_focused] text set value '{"translate":"highliner.lobby.text.replay.jump_speed","color":"yellow","with":[{"score":{"name":"!replay_jump_speed","objective":"constants"}}]}'
execute as @e[type=minecraft:text_display,tag=lobby_display_text2] run data modify entity @s[tag=lobby_display_focused] text set value '{"translate":"highliner.lobby.text.replay.jump_speed","color":"yellow","with":[{"score":{"name":"!replay_jump_speed","objective":"constants"}}],"italic":true,"underlined":true}'
